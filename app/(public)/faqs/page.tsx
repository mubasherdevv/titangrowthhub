...
export async function generateMetadata() {
  const { title, description } = await getPageMeta(
    'faqs',
    'FAQs – Titan Growth Hub',
    'Got questions? Find answers to the most frequently asked questions about our services and approach.'
  );
...
<ul class="dropdown-menu clearfix">
	<li id="menu-item-2600" class="menu-item menu-item-type-post_type menu-item-object-page dropdown menu-item-2600"><a href="/our-team">Team</a>
	<ul class="dropdown-menu clearfix">
		<li id="menu-item-2606" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2606"><a href="/our-team">Team</a></li>
	...
	<li id="menu-item-2594" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-31 current_page_item menu-item-2594"><a href="/" aria-current="page">Faqs</a></li>
...
<ul class="dropdown-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page dropdown menu-item-2600"><a href="/our-team">Team</a>
	<ul class="dropdown-menu">
		<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2606"><a href="/our-team">Team</a></li>
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-31 current_page_item menu-item-2594"><a href="/" aria-current="page">Faqs</a></li>
        ...
        <div class="as-breadcrumb-area wa-p-relative wa-bg-default tx-breadcrumb " data-background="https://themexriver.com/wp/avista/wp-content/uploads/2025/11/tx-bg-img.webp">
            <div class="container as-container-2">
                <div class="as-breadcrumb-wrap">
                    <h1 class="as-breadcrumb-title">Faqs</h1>
                            ...
                            <path d="M20.5153 9.7288L19.1428 11.1835L19.1521 11.1923L19.1616 11.201L20.5153 9.7288ZM13.0153 2.65255L14.3878 1.19783L14.3593 1.17092L14.3297 1.14514L13.0153 2.65255ZM13.005 2.64223L14.5124 1.32781L14.4363 1.24052L14.3506 1.16261L13.005 2.64223ZM11.9958 2.25195L11.9958 0.251953L11.9958 2.25195ZM10.9866 2.64223L9.64094 1.16261L9.60587 1.1945L9.57235 1.22802L10.9866 2.64223ZM10.9763 2.65255L12.3496 4.10649L12.3703 4.08691L12.3905 4.06676L10.9763 2.65255ZM3.48469 9.7288L4.83844 11.201L4.84829 11.1919L4.85803 11.1827L3.48469 9.7288ZM3 10.8332L5 10.8332L5 10.8329L3 10.8332ZM3 19.5004L1 19.5004L3 19.5004ZM10.5 15.0004V13.0004H8.5V15.0004H10.5ZM13.5 15.0004H15.5V13.0004H13.5V15.0004ZM21 10.8332L19 10.8329V10.8332H21ZM19.5 19.5004V21.5004H21.4998L21.5 19.5006L19.5 19.5004ZM15 19.5004H13V21.5004H15V19.5004ZM9 19.5004V21.5004H11V19.5004H9ZM4.5 19.5004H2.5V21.5004H4.5V19.5004ZM4.5 10.8332L3.15461 9.35333L2.5 9.94846V10.8332H4.5ZM4.51031 10.8238L5.8557 12.3036L5.86974 12.2909L5.88354 12.2778L4.51031 10.8238ZM12 3.75036L13.3729 2.29605L11.9997 0.999658L10.6268 2.29632L12 3.75036ZM19.4906 10.8219L18.1177 12.2762L18.1314 12.2892L18.1453 12.3018L19.4906 10.8219ZM19.5009 10.8313L21.5009 10.8315L21.501 9.94663L20.8463 9.3514L19.5009 10.8313ZM20.5153 9.7288L21.8878 8.27408L14.3878 1.19783L13.0153 2.65255L11.6428 4.10726L19.1428 11.1835L20.5153 9.7288ZM13.0153 2.65255L14.3297 1.14514C14.3947 1.2018 14.4557 1.26283 14.5124 1.32781L13.005 2.64223L11.4976 3.95666C11.5606 4.02898 11.6286 4.0969 11.7009 4.15996L13.0153 2.65255ZM13.005 2.64223L14.3506 1.16261C13.7063 0.576649 12.8667 0.251953 11.9958 0.251953L11.9958 2.25195L11.9958 4.25195C11.8714 4.25195 11.7514 4.20557 11.6594 4.12186L13.005 2.64223ZM11.9958 2.25195L11.9958 0.251953C11.1249 0.251953 10.2852 0.576649 9.64094 1.16261L10.9866 2.64223L12.3322 4.12186C12.2401 4.20557 12.1202 4.25195 11.9958 4.25195L11.9958 2.25195ZM10.9866 2.64223L9.57235 1.22802L9.56204 1.23833L10.9763 2.65255L12.3905 4.06676L12.4008 4.05645L10.9866 2.64223ZM10.9763 2.65255L9.60291 1.19861L2.11135 8.27486L3.48469 9.7288L4.85803 11.1827L12.3496 4.10649L10.9763 2.65255ZM3.48469 9.7288L2.13094 8.2566C1.77437 8.58448 1.48974 8.98281 1.29508 9.42637L3.12646 10.2301L4.95785 11.0339C4.93004 11.0972 4.88938 11.1541 4.83844 11.201L3.48469 9.7288ZM3.12646 10.2301L1.29508 9.42637C1.1004 9.86993 0.999926 10.3491 1 10.8335L3 10.8332L5 10.8329C5.00001 10.9021 4.98566 10.9705 4.95785 11.0339L3.12646 10.2301ZM3 10.8332H1V19.5004H3H5V10.8332H3ZM3 19.5004L1 19.5004C1 20.4286 1.36875 21.3189 2.02513 21.9752L3.43934 20.561L4.85355 19.1468C4.94732 19.2406 5 19.3677 5 19.5004L3 19.5004ZM3.43934 20.561L2.02513 21.9752C2.6815 22.6316 3.57174 23.0004 4.5 23.0004V21.0004V19.0004C4.63261 19.0004 4.75979 19.053 4.85355 19.1468L3.43934 20.561ZM4.5 21.0004V23.0004H9V21.0004V19.0004H4.5V21.0004ZM9 21.0004V23.0004C9.92826 23.0004 10.8185 22.6316 11.4749 21.9752L10.0607 20.561L8.64645 19.1468C8.74021 19.053 8.86739 19.0004 9 19.0004V21.0004ZM10.0607 20.561L11.4749 21.9752C12.1312 21.3189 12.5 20.4286 12.5 19.5004H10.5H8.5C8.5 19.3677 8.55268 19.2406 8.64645 19.1468L10.0607 20.561ZM10.5 19.5004H12.5V15.0004H10.5H8.5V19.5004H10.5ZM10.5 15.0004V17.0004H13.5V15.0004V13.0004H10.5V15.0004ZM13.5 15.0004H11.5V19.5004H13.5H15.5V15.0004H13.5ZM13.5 19.5004H11.5C11.5 20.4286 11.8688 21.3189 12.5251 21.9752L13.9393 20.561L15.3536 19.1468C15.4473 19.2406 15.5 19.3677 15.5 19.5004H13.5ZM13.9393 20.561L12.5251 21.9752C13.1815 22.6316 14.0717 23.0004 15 23.0004V21.0004V19.0004C15.1326 19.0004 15.2598 19.053 15.3536 19.1468L13.9393 20.561ZM15 21.0004V23.0004H19.5V21.0004V19.0004H15V21.0004ZM19.5 21.0004V23.0004C20.4283 23.0004 21.3185 22.6316 21.9749 21.9752L20.5607 20.561L19.1464 19.1468C19.2402 19.053 19.3674 19.0004 19.5 19.0004V21.0004ZM20.5607 20.561L21.9749 21.9752C22.6312 21.3189 23 20.4286 23 19.5004H21H19C19 19.3677 19.0527 19.2406 19.1464 19.1468L20.5607 20.561ZM21 19.5004H23V10.8332H21H19V19.5004H21ZM21 10.8332L23 10.8335C23.0001 10.3491 22.8996 9.86993 22.7049 9.42637L20.8735 10.2301L19.0422 11.0339C19.0143 10.9705 19 10.9021 19 10.8329L21 10.8332ZM20.8735 10.2301L22.7049 9.42637C22.5103 8.9828 22.2256 8.58448 21.8691 8.2566L20.5153 9.7288L19.1616 11.201C19.1106 11.1542 19.07 11.0972 19.0422 11.0339L20.8735 10.2301ZM19.5 19.5004V17.5004H15V19.5004V21.5004H19.5V19.5004ZM15 19.5004H17V15.0004H15H13V19.5004H15ZM15 15.0004H17C17 14.0721 16.6312 13.1819 15.9749 12.5255L14.5607 13.9397L13.1464 15.3539C13.0527 15.2601 13 15.133 13 15.0004H15ZM14.5607 13.9397L15.9749 12.5255C15.3185 11.8691 14.4283 11.5004 13.5 11.5004V13.5004V15.5004C13.3674 15.5004 13.2402 15.4477 13.1464 15.3539L14.5607 13.9397ZM13.5 13.5004V11.5004H10.5V13.5004V15.5004H13.5V13.5004ZM10.5 13.5004V11.5004C9.57174 11.5004 8.6815 11.8691 8.02513 12.5255L9.43934 13.9397L10.8536 15.3539C10.7598 15.4477 10.6326 15.5004 10.5 15.5004V13.5004ZM9.43934 13.9397L8.02513 12.5255C7.36875 13.1819 7 14.0721 7 15.0004H9H11C11 15.133 10.9473 15.2601 10.8536 15.3539L9.43934 13.9397ZM9 15.0004H7V19.5004H9H11V15.0004H9ZM9 19.5004V17.5004H4.5V19.5004V21.5004H9V19.5004ZM4.5 19.5004H6.5V10.8332H4.5H2.5V19.5004H4.5ZM4.5 10.8332L5.84539 12.313L5.8557 12.3036L4.51031 10.8238L3.16493 9.34395L3.15461 9.35333L4.5 10.8332ZM4.51031 10.8238L5.88354 12.2778L13.3732 5.2044L12 3.75036L10.6268 2.29632L3.13708 9.36975L4.51031 10.8238ZM12 3.75036L10.6271 5.20467L18.1177 12.2762L19.4906 10.8219L20.8636 9.36761L13.3729 2.29605L12 3.75036ZM19.4906 10.8219L18.1453 12.3018L18.1556 12.3112L19.5009 10.8313L20.8463 9.3514L20.836 9.34203L19.4906 10.8219ZM19.5009 10.8313L17.5009 10.8311L17.5 19.5001L19.5 19.5004L21.5 19.5006L21.5009 10.8315L19.5009 10.8313Z" fill="#FB0D1F" mask="url(#path-1-inside-1_23214_336)"/>
                                                ...
                                                <nav aria-label="Breadcrumbs" class="tx-breadcrumb__wrapper"><ul class="bread-crumb clearfix list-unstyled d-flex flex-wrap m-0" itemscope itemtype="http://schema.org/BreadcrumbList"><li itemprop="item ListElement" itemscope itemtype="http://schema.org/ListItem" class="item taBcrumb-begin"><a href="/" rel="home" itemprop="item"><span itemprop="name">Home</span></a><meta itemprop="position" content="1" /></li><li class="item taBcrumb-end"><span>Faqs</span></li></ul></nav>                    </div>
                                    </div>
            </div>
        </div>
        <!-- breadcrumb-end -->
        		<div data-elementor-type="wp-page" data-elementor-id="31" class="elementor elementor-31">
				<div class="elementor-element elementor-element-6bede06 e-con-full e-flex e-con e-parent" data-id="6bede06" data-element_type="container">
				<div class="elementor-element elementor-element-1b58830 elementor-widget elementor-widget-tx_service_section elh-el tx_service_section" data-id="1b58830" data-element_type="widget" data-settings="{&quot;design_style&quot;:&quot;style_3&quot;}" data-widget_type="tx_service_section.default">
				<div class="elementor-widget-container">
    ...
    <div class="p1_pin_elm">
        <div class="container as-container-1 ">
            <div class="as-process-1-wrap">
                ...
                <div class="as-process-1-sec-title ">
                    <div class="left">
                        <h2 class="tx-title as-sec-title-1">Our Working <br> process</h2>                                                <p class="as-p-1 sec-disc tx-description">
                            We begin by listening, gaining a deep understanding of your goals, audience, and challenges through research and conversation.                        </p>
                                            </div>
                ...
                <div class="as-process-1-right ">
                                        <div class="as-process-1-card wa-bg-default " data-background="https://themexriver.com/wp/avista/wp-content/uploads/2025/10/s1-card-shape-1.webp">
                        <div class="step-x-btn">
                                                        <h4 class="as-h-1 step">
                                Step 01                                <i aria-hidden="true" class="flaticon flaticon-star"></i>                            </h4>
                                                        <!-- pr-btn -->

                                                        <a href="../services/smart-schedule-control/index.html"
                            target="_self"
                            rel=""
                            aria-label="Explore" class="as-pr-btn-1-v2 tx-button">
                                <span class="text">
                                    Explore                                </span>
                                <span class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" id="fi_12116860" height="100" viewBox="0 0 100 100" width="100"><g><circle cx="90.5" cy="50" r="4.5"></circle><circle cx="77" cy="50" r="4.5"></circle><circle cx="77" cy="63.5" r="4.5"></circle><circle cx="77" cy="36.5" r="4.5"></circle><circle cx="63.5" cy="50" r="4.5"></circle><circle cx="50" cy="50" r="4.5"></circle><circle cx="36.5" cy="50" r="4.5"></circle><circle cx="23" cy="50" r="4.5"></circle><circle cx="9.5" cy="50" r="4.5"></circle><circle cx="63.5" cy="77" r="4.5"></circle><circle cx="63.5" cy="23" r="4.5"></circle></g></svg>                                </span>
                                                ...
                                                <p class="as-p-1 disc">We start by understanding your business, your goals, and your market.</p>
                                            </div>
                                        <div class="as-process-1-card wa-bg-default p1_ani_elm" data-background="https://themexriver.com/wp/avista/wp-content/uploads/2025/10/s1-card-shape-1.webp">
                        <div class="step-x-btn">
                                                        <h4 class="as-h-1 step">
                                Step 02                                <i aria-hidden="true" class="flaticon flaticon-star"></i>                            </h4>
                                                        <!-- pr-btn -->
                            ...
                            aria-label="Explore" class="as-pr-btn-1-v2 tx-button">
                                ...
                                <span class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" id="fi_12116860" height="100" viewBox="0 0 100 100" width="100"><g><circle cx="90.5" cy="50" r="4.5"></circle><circle cx="77" cy="50" r="4.5"></circle><circle cx="77" cy="63.5" r="4.5"></circle><circle cx="77" cy="36.5" r="4.5"></circle><circle cx="63.5" cy="50" r="4.5"></circle><circle cx="50" cy="50" r="4.5"></circle><circle cx="36.5" cy="50" r="4.5"></circle><circle cx="23" cy="50" r="4.5"></circle><circle cx="9.5" cy="50" r="4.5"></circle><circle cx="63.5" cy="77" r="4.5"></circle><circle cx="63.5" cy="23" r="4.5"></circle></g></svg>                                </span>
                                                ...
                                                <p class="as-p-1 disc">We breathe life into concepts, creating vibrant experiences that captivate.</p>
                                            </div>
                                        <div class="as-process-1-card wa-bg-default p1_ani_elm" data-background="https://themexriver.com/wp/avista/wp-content/uploads/2025/10/s1-card-shape-1.webp">
                        <div class="step-x-btn">
                                                        <h4 class="as-h-1 step">
                                Step 03                                <i aria-hidden="true" class="flaticon flaticon-star"></i>                            </h4>
                                                        <!-- pr-btn -->
                            ...
                            aria-label="Explore" class="as-pr-btn-1-v2 tx-button">
                                ...
                                <span class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" id="fi_12116860" height="100" viewBox="0 0 100 100" width="100"><g><circle cx="90.5" cy="50" r="4.5"></circle><circle cx="77" cy="50" r="4.5"></circle><circle cx="77" cy="63.5" r="4.5"></circle><circle cx="77" cy="36.5" r="4.5"></circle><circle cx="63.5" cy="50" r="4.5"></circle><circle cx="50" cy="50" r="4.5"></circle><circle cx="36.5" cy="50" r="4.5"></circle><circle cx="23" cy="50" r="4.5"></circle><circle cx="9.5" cy="50" r="4.5"></circle><circle cx="63.5" cy="77" r="4.5"></circle><circle cx="63.5" cy="23" r="4.5"></circle></g></svg>                                </span>
                                                ...
                                                <p class="as-p-1 disc">We breathe life into concepts, creating vibrant experiences tha</p>
                                            </div>
                                    </div>
            </div>
        </div>
		...
		<div class="elementor-element elementor-element-0978474 e-con-full e-flex e-con e-parent" data-id="0978474" data-element_type="container">
				<div class="elementor-element elementor-element-8260947 elementor-widget elementor-widget-tx_tabs elh-el tx_tabs" data-id="8260947" data-element_type="widget" data-settings="{&quot;design_style&quot;:&quot;style_1&quot;}" data-widget_type="tx_tabs.default">
				<div class="elementor-widget-container">
        ...
        <div class="as-faqs-1-wrap">
            ...
            <div class="as-faqs-1-left">
                ...
                <div class="as-faqs-1-left-sec-title text-center mb-60">
                        ...
                        Awards                    </h6>
                                        <h2 class="tx-title as-sec-title-1">Excellence and innovation drive everything we do</h2>                                        <p class="tx-description">
                                            </p>
                                    </div>
                ...
                <div class="as-faqs-1-awards">
                    ...
                    alt="faqs1-clr" class="bg-shape-3">
                                                                    ...
                                                                    <p class="as-faqs-1-awards-single as-p-1 wow backInUp2" data-wow-delay=".1s">
            ...
            <div class="as-faqs-1-right">
                ...
                <div class="as-faqs-1-right-sec-title text-center mb-40">
                        ...
                        <span class="icon">
                            {<i aria-hidden="true" class="fas fa-circle"></i>}                        </span>
                        FAQs                    </h6>
                                        <h2 class="tx-title as-sec-title-1">Learn more from FAQs</h2>                                        <p class="tx-description">
                                            </p>
                                    </div>

                <!-- tabs-btn -->
                <div class="as-faqs-1-tabs-btn" role="tablist">
                                        <button class="nav-link as-h-1 active"
                        id="projectTab-0_9504"
                        data-bs-toggle="tab"
                        data-bs-target="#tab-0_9504"
                        type="button"
                        role="tab"
                        aria-controls="tab-0_9504"
                        aria-selected="true">
                        Ask                    </button>
                                        <button class="nav-link as-h-1 "
                        id="projectTab-1_9504"
                        data-bs-toggle="tab"
                        data-bs-target="#tab-1_9504"
                        type="button"
                        role="tab"
                        aria-controls="tab-1_9504"
                        aria-selected="false">
                        Job Career                    </button>
                                        <button class="nav-link as-h-1 "
                        id="projectTab-2_9504"
                        data-bs-toggle="tab"
                        data-bs-target="#tab-2_9504"
                        type="button"
                        role="tab"
                        aria-controls="tab-2_9504"
                        aria-selected="false">
                        Pricing &amp; Plan                    </button>
                ...
                <div class="tab-content as-faqs-1-tabs-pane mt-50">
                    ...
                    aria-labelledby="projectTab-0_9504">
                        <style>.elementor-2141 .elementor-element.elementor-element-1c790c7{--display:flex;}</style>		<div data-elementor-type="section" data-elementor-id="2141" class="elementor elementor-2141">
				<div class="elementor-element elementor-element-1c790c7 e-flex e-con-boxed e-con e-parent" data-id="1c790c7" data-element_type="container">
					<div class="e-con-inner">
				<div class="elementor-element elementor-element-924fed3 elementor-widget elementor-widget-tx_faq elh-el tx_faq" data-id="924fed3" data-element_type="widget" data-settings="{&quot;design_style&quot;:&quot;style_1&quot;}" data-widget_type="tx_faq.default">
				<div class="elementor-widget-container">
    ...
    <div class="as-accordion" id="accordionExample_742">
            ...
            <button class="item-title as-h-1 "
                ...
                aria-controls="collapse-742-0">
                                <span class="text">
                    01.                </span>
                                What services do you offer?                <span class="icon">
            ...
            <div id="collapse-742-0"
                ...
                <p class="as-p-1 item-disc">
                    Simply <a href="#" aria-label="name">contact us</a>
                                                        or send us a message. We’ll schedule a quick call to learn more about your goals and get started with a tailored plan.                </p>
            </div>
        </div>
            ...
            <button class="item-title as-h-1 collapsed"
                ...
                aria-controls="collapse-742-1">
                                <span class="text">
                    02.                </span>
                                How long does a website project take?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
                </span>
            </button>
            ...
            <button class="item-title as-h-1 collapsed"
                ...
                aria-controls="collapse-742-2">
                                <span class="text">
                    03.                </span>
                                Do you work with international clients?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
                </span>
            </button>
            ...
            <button class="item-title as-h-1 collapsed"
                ...
                aria-controls="collapse-742-3">
                                <span class="text">
                    04.                </span>
                                Can you redesign my existing website?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
                </span>
            </button>
            ...
            <button class="item-title as-h-1 collapsed"
                ...
                aria-controls="collapse-742-4">
                                <span class="text">
                    05.                </span>
                                How do I get started?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
                </span>
            </button>
            <div id="collapse-742-4"
                ...
                <p class="as-p-1 item-disc">
                    ...
                    id="tab-1_9504"
                    role="tabpanel"
                    aria-labelledby="projectTab-1_9504">
                        <style>.elementor-2141 .elementor-element.elementor-element-1c790c7{--display:flex;}</style>		<div data-elementor-type="section" data-elementor-id="2141" class="elementor elementor-2141">
				<div class="elementor-element elementor-element-1c790c7 e-flex e-con-boxed e-con e-parent" data-id="1c790c7" data-element_type="container">
					<div class="e-con-inner">
				<div class="elementor-element elementor-element-924fed3 elementor-widget elementor-widget-tx_faq elh-el tx_faq" data-id="924fed3" data-element_type="widget" data-settings="{&quot;design_style&quot;:&quot;style_1&quot;}" data-widget_type="tx_faq.default">
				<div class="elementor-widget-container">
					<div class="as-faqs-1-tabs-pane-single">
    <div class="as-accordion" id="accordionExample_44">
                <div class="as-accordion-item  wa_accordion_item active wow fadeInUp2" >
            <button class="item-title as-h-1 "
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#collapse-44-0"
                aria-expanded="true"
                aria-controls="collapse-44-0">
                                <span class="text">
                    01.                </span>
                                What services do you offer?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
            ...
            <div id="collapse-44-0"
                class="accordion-collapse collapse show"
                aria-labelledby="heading-44-0"
                data-bs-parent="#accordionExample_44">
                <p class="as-p-1 item-disc">
                    Simply <a href="#" aria-label="name">contact us</a>
                                                        or send us a message. We’ll schedule a quick call to learn more about your goals and get started with a tailored plan.                </p>
            </div>
            ...
            <button class="item-title as-h-1 collapsed"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#collapse-44-1"
                aria-expanded="false"
                aria-controls="collapse-44-1">
                                <span class="text">
                    02.                </span>
                                How long does a website project take?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
            ...
            <div id="collapse-44-1"
                class="accordion-collapse collapse "
                aria-labelledby="heading-44-1"
                data-bs-parent="#accordionExample_44">
                <p class="as-p-1 item-disc">
                    Simply <a href="#" aria-label="name">contact us</a>
                                                        or send us a message. We’ll schedule a quick call to learn more about your goals and get started with a tailored plan.                </p>
            ...
            <button class="item-title as-h-1 collapsed"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#collapse-44-2"
                aria-expanded="false"
                aria-controls="collapse-44-2">
                                <span class="text">
                    03.                </span>
                                Do you work with international clients?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
            ...
            <div id="collapse-44-2"
                class="accordion-collapse collapse "
                aria-labelledby="heading-44-2"
                data-bs-parent="#accordionExample_44">
                <p class="as-p-1 item-disc">
                    Simply <a href="#" aria-label="name">contact us</a>
                                                        or send us a message. We’ll schedule a quick call to learn more about your goals and get started with a tailored plan.                </p>
            ...
            <button class="item-title as-h-1 collapsed"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#collapse-44-3"
                aria-expanded="false"
                aria-controls="collapse-44-3">
                                <span class="text">
                    04.                </span>
                                Can you redesign my existing website?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
            ...
            <div id="collapse-44-3"
                class="accordion-collapse collapse "
                aria-labelledby="heading-44-3"
                data-bs-parent="#accordionExample_44">
                <p class="as-p-1 item-disc">
                    Simply <a href="#" aria-label="name">contact us</a>
                                                        or send us a message. We’ll schedule a quick call to learn more about your goals and get started with a tailored plan.                </p>
            ...
            <button class="item-title as-h-1 collapsed"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#collapse-44-4"
                aria-expanded="false"
                aria-controls="collapse-44-4">
                                <span class="text">
                    05.                </span>
                                How do I get started?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
            ...
            <div id="collapse-44-4"
                class="accordion-collapse collapse "
                aria-labelledby="heading-44-4"
                data-bs-parent="#accordionExample_44">
                <p class="as-p-1 item-disc">
                    Simply <a href="#" aria-label="name">contact us</a>
                                                        or send us a message. We’ll schedule a quick call to learn more about your goals and get started with a tailored plan.                </p>
                    ...
                    id="tab-2_9504"
                    role="tabpanel"
                    aria-labelledby="projectTab-2_9504">
                        <style>.elementor-2141 .elementor-element.elementor-element-1c790c7{--display:flex;}</style>		<div data-elementor-type="section" data-elementor-id="2141" class="elementor elementor-2141">
				<div class="elementor-element elementor-element-1c790c7 e-flex e-con-boxed e-con e-parent" data-id="1c790c7" data-element_type="container">
					<div class="e-con-inner">
				<div class="elementor-element elementor-element-924fed3 elementor-widget elementor-widget-tx_faq elh-el tx_faq" data-id="924fed3" data-element_type="widget" data-settings="{&quot;design_style&quot;:&quot;style_1&quot;}" data-widget_type="tx_faq.default">
				<div class="elementor-widget-container">
					<div class="as-faqs-1-tabs-pane-single">
    <div class="as-accordion" id="accordionExample_886">
                <div class="as-accordion-item  wa_accordion_item active wow fadeInUp2" >
            <button class="item-title as-h-1 "
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#collapse-886-0"
                aria-expanded="true"
                aria-controls="collapse-886-0">
                                <span class="text">
                    01.                </span>
                                What services do you offer?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
            ...
            <div id="collapse-886-0"
                class="accordion-collapse collapse show"
                aria-labelledby="heading-886-0"
                data-bs-parent="#accordionExample_886">
                <p class="as-p-1 item-disc">
                    Simply <a href="#" aria-label="name">contact us</a>
                                                        or send us a message. We’ll schedule a quick call to learn more about your goals and get started with a tailored plan.                </p>
            </div>
            ...
            <button class="item-title as-h-1 collapsed"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#collapse-886-1"
                aria-expanded="false"
                aria-controls="collapse-886-1">
                                <span class="text">
                    02.                </span>
                                How long does a website project take?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
            ...
            <div id="collapse-886-1"
                class="accordion-collapse collapse "
                aria-labelledby="heading-886-1"
                data-bs-parent="#accordionExample_886">
                <p class="as-p-1 item-disc">
                    Simply <a href="#" aria-label="name">contact us</a>
                                                        or send us a message. We’ll schedule a quick call to learn more about your goals and get started with a tailored plan.                </p>
            ...
            <button class="item-title as-h-1 collapsed"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#collapse-886-2"
                aria-expanded="false"
                aria-controls="collapse-886-2">
                                <span class="text">
                    03.                </span>
                                Do you work with international clients?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
            ...
            <div id="collapse-886-2"
                class="accordion-collapse collapse "
                aria-labelledby="heading-886-2"
                data-bs-parent="#accordionExample_886">
                <p class="as-p-1 item-disc">
                    Simply <a href="#" aria-label="name">contact us</a>
                                                        or send us a message. We’ll schedule a quick call to learn more about your goals and get started with a tailored plan.                </p>
            ...
            <button class="item-title as-h-1 collapsed"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#collapse-886-3"
                aria-expanded="false"
                aria-controls="collapse-886-3">
                                <span class="text">
                    04.                </span>
                                Can you redesign my existing website?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
            ...
            <div id="collapse-886-3"
                class="accordion-collapse collapse "
                aria-labelledby="heading-886-3"
                data-bs-parent="#accordionExample_886">
                <p class="as-p-1 item-disc">
                    Simply <a href="#" aria-label="name">contact us</a>
                                                        or send us a message. We’ll schedule a quick call to learn more about your goals and get started with a tailored plan.                </p>
            ...
            <button class="item-title as-h-1 collapsed"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#collapse-886-4"
                aria-expanded="false"
                aria-controls="collapse-886-4">
                                <span class="text">
                    05.                </span>
                                How do I get started?                <span class="icon">
                    <i class="fa-solid fa-plus"></i>
            ...
            <div id="collapse-886-4"
                class="accordion-collapse collapse "
                aria-labelledby="heading-886-4"
                data-bs-parent="#accordionExample_886">
                <p class="as-p-1 item-disc">
                    Simply <a href="#" aria-label="name">contact us</a>
                                                        or send us a message. We’ll schedule a quick call to learn more about your goals and get started with a tailored plan.                </p>
...
<form action="https://themexriver.com/wp/avista/faqs/#wpcf7-f2678-o1" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
        ...
        <span class="text wa-fix">Subscribe</span>
                ...
                <!-- single-widget -->
                    ...
                    <div class="wow backInUp2">
                        <a href="https://themexriver.com/cdn-cgi/l/email-protection#4a23242c250a2d272b232664292527" target="_self" rel="" aria-label="info@gmail.com" class="as-footer-1-big-email as-p-1 ">
                            <span class="text wa_magnetic_btn_1">
                                <span class="__cf_email__" data-cfemail="7c15121a133c1b111d1510521f1311">[email&#160;protected]</span>                            </span>
                        </a>
                    </div>
                </div>
...
<script src="/wp-content/themes/avista/assets/js/avista-core9280.js?ver=1785262581" id="avista-core-js"></script>
