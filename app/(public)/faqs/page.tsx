        ...
        <div class="container as-container-1 ">
            <div class="as-process-1-wrap">
                ...
                <div class="as-process-1-right ">
                                        <div class="as-process-1-card wa-bg-default " data-background="https://themexriver.com/wp/avista/wp-content/uploads/2025/10/s1-card-shape-1.webp" style="background-image: url('https://themexriver.com/wp/avista/wp-content/uploads/2025/10/s1-card-shape-1.webp');">
                        <div class="step-x-btn">
                                                        <h4 class="as-h-1 step">
                                Step 01                                <i aria-hidden="true" class="fa-solid fa-star" style="color: #f65022;"></i>                            </h4>
                                                        <!-- pr-btn -->
                            ...
                            aria-label="Explore" class="as-pr-btn-1-v2 tx-button">
                                ...
                                <span class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" id="fi_12116860" height="100" viewBox="0 0 100 100" width="100"><g><circle cx="90.5" cy="50" r="4.5"></circle><circle cx="77" cy="50" r="4.5"></circle><circle cx="77" cy="63.5" r="4.5"></circle><circle cx="77" cy="36.5" r="4.5"></circle><circle cx="63.5" cy="50" r="4.5"></circle><circle cx="50" cy="50" r="4.5"></circle><circle cx="36.5" cy="50" r="4.5"></circle><circle cx="23" cy="50" r="4.5"></circle><circle cx="9.5" cy="50" r="4.5"></circle><circle cx="63.5" cy="77" r="4.5"></circle><circle cx="63.5" cy="23" r="4.5"></circle></g></svg>                                </span>
                                        ...
                                        <div class="as-process-1-card wa-bg-default p1_ani_elm" data-background="https://themexriver.com/wp/avista/wp-content/uploads/2025/10/s1-card-shape-1.webp" style="background-image: url('https://themexriver.com/wp/avista/wp-content/uploads/2025/10/s1-card-shape-1.webp');">
                        <div class="step-x-btn">
                                                        <h4 class="as-h-1 step">
                                Step 02                                <i aria-hidden="true" class="fa-solid fa-star" style="color: #f65022;"></i>                            </h4>
                                                        <!-- pr-btn -->
                        ...
                        <div class="step-x-btn">
                                                        <h4 class="as-h-1 step">
                                Step 03                                <i aria-hidden="true" class="fa-solid fa-star" style="color: #f65022;"></i>                            </h4>
                                                        <!-- pr-btn -->
