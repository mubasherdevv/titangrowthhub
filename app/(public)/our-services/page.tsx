...
<li id="menu-item-2599" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-25 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor dropdown menu-item-2599"><a href="/" aria-current="page">Services</a>
<ul class="dropdown-menu clearfix">
	<li id="menu-item-2613" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-25 current_page_item menu-item-2613"><a href="/" aria-current="page">Services</a></li>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-25 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor dropdown menu-item-2599"><a href="/" aria-current="page">Services</a>
<ul class="dropdown-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-25 current_page_item menu-item-2613"><a href="/" aria-current="page">Services</a></li>
        ...
        <div class="as-services-1-container">
            ...
            <div class="as-services-1-wrap">
                            ...
                            CMS Integration                        </li>
                                        ...
                                        <img decoding="async" class="star-icon" src="/wp-content/uploads/2025/10/star-icon.webp" alt="star-icon">
                    
                                        <div class="icon-elm">
                        <img decoding="async" src="/wp-content/uploads/2025/10/s1-logo-1.webp" alt="s1-logo-1">
                    </div>
                    ...
                    <div class="right-content wa-fix">
                            ...
                            <img decoding="async" src="/wp-content/uploads/2025/11/s1-card-img-1.webp" alt="s1-card-img-1">
                        </div>
                                ...
                                rel=""
                                aria-label="Web Design &amp; Development">
                                                                        <img decoding="async" src="/wp-content/uploads/2025/10/right-up.webp" alt="right-up">
                                                                        Web Design &amp; Development                                </a>
                            </h4>
                                                    </div>
                            ...
                            Brand Promotion                        </li>
                                        ...
                                        <div class="icon-elm">
                        <img decoding="async" src="/wp-content/uploads/2025/10/s1-logo-2.webp" alt="s1-logo-2">
                    </div>
                    ...
                    <div class="right-content wa-fix">
                                                <div class="right-content-bg-img wa-fix wa-img-cover">
                            <img decoding="async" src="/wp-content/uploads/2025/11/s1-card-img-2.webp" alt="s1-card-img-2">
                        </div>
                                                <div class="title-wrap">
                                                        <h4 class="as-h-1 title">
                                <a href="../services/smart-schedule-control/index.html"
                            ...
                            Android                        </li>
                                        ...
                                        <div class="icon-elm">
                        <img decoding="async" src="/wp-content/uploads/2025/10/s1-logo-3.webp" alt="s1-logo-3">
                    </div>
                    ...
                    <div class="right-content wa-fix">
                                                <div class="right-content-bg-img wa-fix wa-img-cover">
                            <img decoding="async" src="/wp-content/uploads/2025/11/s1-card-img-3.webp" alt="s1-card-img-3">
                        </div>
                                                <div class="title-wrap">
                                                        <h4 class="as-h-1 title">
                                <a href="../services/smart-schedule-control/index.html"
                            ...
                            CMS Integration                        </li>
                                        ...
                                        <div class="icon-elm">
                        <img decoding="async" src="/wp-content/uploads/2025/10/s1-logo-4.webp" alt="s1-logo-4">
                    </div>
                    ...
                    <div class="right-content wa-fix">
                                                <div class="right-content-bg-img wa-fix wa-img-cover">
                            <img decoding="async" src="/wp-content/uploads/2025/11/s1-card-img-4.webp" alt="s1-card-img-4">
                        </div>
                                                <div class="title-wrap">
                                                        <h4 class="as-h-1 title">
                                <a href="../services/smart-schedule-control/index.html"
...
<form action="https://themexriver.com/wp/avista/our-services/#wpcf7-f2678-o1" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
        ...
        <span class="text wa-fix">Subscribe</span>
                ...
                <!-- single-widget -->
                    ...
                    <div class="wow backInUp2">
                        <a href="https://themexriver.com/cdn-cgi/l/email-protection#543d3a323b143339353d387a373b39" target="_self" rel="" aria-label="info@gmail.com" class="as-footer-1-big-email as-p-1 ">
                            <span class="text wa_magnetic_btn_1">
                                <span class="__cf_email__" data-cfemail="60090e060f20070d01090c4e030f0d">[email&#160;protected]</span>                            </span>
                        </a>
                    </div>
                </div>
    ...
    <>
      <script
        dangerouslySetInnerHTML={{
          __html: `document.body.className = "wp-singular page-template page-template-elementor_header_footer page page-id-25 wp-embed-responsive wp-theme-avista theme-avista woocommerce-no-js no-sidebar elementor-default elementor-template-full-width elementor-kit-7 elementor-page elementor-page-25";`,
        }}
      />
