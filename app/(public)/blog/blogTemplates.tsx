...
<ul class="dropdown-menu clearfix">
	...
	<li id="menu-item-2589" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-35 current_page_item current_page_parent current-menu-ancestor current-menu-parent current_page_ancestor dropdown menu-item-2589"><a href="/" aria-current="page">Blog</a>
	<ul class="dropdown-menu clearfix">
		<li id="menu-item-2608" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-35 current_page_item current_page_parent menu-item-2608"><a href="/" aria-current="page">Blog</a></li>
...
<ul class="dropdown-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-35 current_page_item current_page_parent current-menu-ancestor current-menu-parent current_page_ancestor dropdown menu-item-2589"><a href="/" aria-current="page">Blog</a>
	<ul class="dropdown-menu">
		<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-35 current_page_item current_page_parent menu-item-2608"><a href="/" aria-current="page">Blog</a></li>
...
<form action="https://themexriver.com/wp/avista/blog/#wpcf7-f2678-o1" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
        ...
        <span class="text wa-fix">Subscribe</span>
                ...
                <!-- single-widget -->
                    ...
                    <div class="wow backInUp2">
                        <a href="https://themexriver.com/cdn-cgi/l/email-protection#c0a9aea6af80a7ada1a9aceea3afad" target="_self" rel="" aria-label="info@gmail.com" class="as-footer-1-big-email as-p-1 ">
                            <span class="text wa_magnetic_btn_1">
                                <span class="__cf_email__" data-cfemail="fa93949c95ba9d979b9396d4999597">[email&#160;protected]</span>                            </span>
                        </a>
                    </div>
                </div>
